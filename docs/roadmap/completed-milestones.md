...
```powershell
dotnet build GitCandy.slnx --configuration Release --artifacts-path .artifacts/build-m13-release
dotnet test tests/GitCandy.Data.Tests/GitCandy.Data.Tests.csproj --configuration Release --no-build --no-restore --artifacts-path .artifacts/build-m13-release
dotnet test tests/GitCandy.Tests/GitCandy.Tests.csproj --configuration Release --no-build --no-restore --artifacts-path .artifacts/build-m13-release
```
