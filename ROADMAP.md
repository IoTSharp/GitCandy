...
- M14 的四级团队治理、企业连接、Microsoft Entra ID/SCIM、企业微信/飞书/钉钉、目录对账与同步停用已完成；M15 的 remote account/provider 抽象和 Remote/Mirror EF schema 已完成，当前进入绑定与设置 UI，M15.5-M16 继续按依赖顺序推进。
