        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedProject = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedSlug = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldSlug = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    NewSlug = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NamespaceId = table.Column<long>(type: "INTEGER", nullable: false),
                    Slug = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    NormalizedSlug = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NamespaceAliasId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepositoryAliasId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(
                """
                UPDATE "Teams" SET "DisplayName" = "Name" WHERE "DisplayName" = '';
                UPDATE "Repositories" SET "StorageName" = "Name" WHERE "StorageName" = '';

                INSERT INTO "Namespaces" ("OwnerType", "UserId", "TeamId", "Slug", "NormalizedSlug", "CreatedAtUtc", "Version")
                SELECT 1, "Id", NULL, "UserName", "NormalizedUserName", datetime('now'), 0
                FROM "AspNetUsers"
                ...
                UPDATE "Repositories"
                SET "NamespaceId" = COALESCE((
                    SELECT n."Id"
                    FROM "UserRepositoryRoles" ur
                    INNER JOIN "Namespaces" n ON n."UserId" = ur."UserId"
                    WHERE ur."RepositoryId" = "Repositories"."Id" AND ur."IsOwner" = 1
                    ORDER BY ur."UserId"
                    LIMIT 1
                ), 1);
