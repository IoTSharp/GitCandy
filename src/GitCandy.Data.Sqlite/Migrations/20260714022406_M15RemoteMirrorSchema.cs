        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerTeamId = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    ExternalAccountId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    AccountKind = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    ...
                    AuthenticationKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CredentialReference = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    GrantedScopes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteRepositoryId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RemoteOwnerLogin = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RemoteRepositoryName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RemoteGitUrl = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    Direction = table.Column<string>(type: "TEXT", maxLength: 8, nullable: false),
                    Authority = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    RefFilterKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    RefFilterPattern = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ScheduleIntervalMinutes = table.Column<int>(type: "INTEGER", nullable: true),
                    ScheduleTimeZone = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ScheduleEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    DivergencePolicy = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    Prune = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    LastObservedRemoteHead = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    LastErrorCode = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
