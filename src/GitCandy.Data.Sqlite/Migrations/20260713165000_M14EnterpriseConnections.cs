        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalOrganizationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Authority = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ClientId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ApiBaseUrl = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ConfigurationJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    SecretReference = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    SyncCursor = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    LoginEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ProvisioningEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    LastSynchronizedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedUserName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ...
                    DeprovisionedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
