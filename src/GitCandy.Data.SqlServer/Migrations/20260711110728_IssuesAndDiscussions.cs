        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiddenByUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRepositoryId = table.Column<long>(type: "bigint", nullable: true),
                    TargetIssueId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepositoryId = table.Column<long>(type: "bigint", nullable: false),
                    SourceIssueId = table.Column<long>(type: "bigint", nullable: false),
                    TargetIssueId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditorUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    PreviousMarkdown = table.Column<string>(type: "nvarchar(max)", maxLength: 65536, nullable: false),
                    PreviousHtml = table.Column<string>(type: "nvarchar(max)", maxLength: 131072, nullable: false),
