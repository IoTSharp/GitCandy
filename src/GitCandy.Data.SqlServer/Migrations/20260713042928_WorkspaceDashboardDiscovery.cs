        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceType = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastInteractedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessfulDownloadCount = table.Column<long>(type: "bigint", nullable: false),
                    SuccessfulGitFetchCount = table.Column<long>(type: "bigint", nullable: false),
                    UniquePageViewCount = table.Column<long>(type: "bigint", nullable: false),
                    LicenseSpdx = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SnapshotId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    RepositoryId = table.Column<long>(type: "bigint", nullable: false),
