...
namespace GitCandy.Data.SqlServer.Migrations
{
    ...
    [Migration("20260823183544_M15RemoteProviderLifecycle")]
    partial class M15RemoteProviderLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GitCandy.Data.Domain.GitCandyRemoteAccountConnection", b =>
                {
                    ...
                    b.HasIndex("OwnerUserId", "IsEnabled")
                        .HasDatabaseName("IX_RemoteAccountConnections_User_Enabled");

                    b.HasIndex("Provider", "ServerUrl", "ExternalAccountId")
                        .IsUnique()
            ...
            modelBuilder.Entity("GitCandy.Data.Domain.GitCandyRepositoryMirror", b =>
                {
                    ...
                    b.Property<string>("DivergencePolicy")
                        .IsRequired()
                        .HasMaxLength(24)
                        .HasColumnType("nvarchar(24)");
                    ...
                    b.Property<string>("LastObservedRemoteHead")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<bool>("Prune")
                        .HasColumnType("bit");

                    b.Property<string>("RefFilterKind")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("RefFilterPattern")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("RemoteGitUrl")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");

                    b.Property<string>("RemoteOwnerLogin")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("RemoteRepositoryId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("RemoteRepositoryName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.ToTable("RepositoryMirrors", null, t =>
                        {
                            t.HasCheckConstraint("CK_RepositoryMirrors_DirectionAuthority", "(Direction = 'Pull' AND Authority = 'Remote') OR (Direction = 'Push' AND Authority = 'GitCandy')");

                            t.HasCheckConstraint("CK_RepositoryMirrors_RefFilter", "(RefFilterKind IN ('AllRefs', 'ProtectedBranches') AND RefFilterPattern IS NULL) OR (RefFilterKind IN ('AllowList', 'RegularExpression') AND RefFilterPattern IS NOT NULL)");

                            t.HasCheckConstraint("CK_RepositoryMirrors_ScheduleConfiguration", "(ScheduleIntervalMinutes IS NULL AND ScheduleTimeZone IS NULL) OR (ScheduleIntervalMinutes IS NOT NULL AND ScheduleTimeZone IS NOT NULL)");

                            t.HasCheckConstraint("CK_RepositoryMirrors_ScheduleInterval", "ScheduleIntervalMinutes IS NULL OR (ScheduleIntervalMinutes >= 5 AND ScheduleIntervalMinutes <= 10080)");
                        });
                });
            ...
            modelBuilder.Entity("GitCandy.Data.Domain.GitCandyRemoteAccountConnection", b =>
                {
                    b.HasOne("GitCandy.Data.Domain.GitCandyTeam", "OwnerTeam")
                        .WithMany()
                        .HasForeignKey("OwnerTeamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GitCandy.Data.Identity.GitCandyUser", "OwnerUser")
                        .WithMany()
