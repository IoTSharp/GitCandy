        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedGeneration = table.Column<long>(type: "INT", nullable: false),
                    ProcessedGeneration = table.Column<long>(type: "INT", nullable: false),
                    AttemptCount = table.Column<int>(type: "INT", nullable: false),
                    AvailableAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    LeaseOwner = table.Column<string>(type: "STRING", maxLength: 128, nullable: true),
                    LeaseExpiresAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: true),
                    CancellationRequestedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: true),
                    LastErrorCode = table.Column<string>(type: "STRING", maxLength: 64, nullable: true),
                    LastStartedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: true),
                    LastCompletedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: true),
