    ...
    public partial class WorkspaceDashboardDiscovery : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventId = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    ...
                    ResourceType = table.Column<string>(type: "STRING", maxLength: 24, nullable: false),
                    ResourceId = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    Type = table.Column<string>(type: "STRING", maxLength: 32, nullable: false),
                    Title = table.Column<string>(type: "STRING", maxLength: 300, nullable: false),
                    Url = table.Column<string>(type: "STRING", maxLength: 600, nullable: false),
                    OccurredAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    RetainUntilUtc = table.Column<DateTime>(type: "DATETIME", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceType = table.Column<string>(type: "STRING", maxLength: 24, nullable: false),
                    ResourceId = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    Reason = table.Column<string>(type: "STRING", maxLength: 24, nullable: false),
                    Title = table.Column<string>(type: "STRING", maxLength: 300, nullable: false),
                    Url = table.Column<string>(type: "STRING", maxLength: 600, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastInteractedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RepositoryId = table.Column<long>(type: "INT", nullable: false),
                    DayUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    CommitCount = table.Column<int>(type: "INT", nullable: false),
                    ActiveCommitDays = table.Column<int>(type: "INT", nullable: false),
                    StarCount = table.Column<int>(type: "INT", nullable: false),
                    StarNetGrowth = table.Column<int>(type: "INT", nullable: false),
                    SuccessfulDownloadCount = table.Column<long>(type: "INT", nullable: false),
                    SuccessfulGitFetchCount = table.Column<long>(type: "INT", nullable: false),
                    UniquePageViewCount = table.Column<long>(type: "INT", nullable: false),
                    LicenseSpdx = table.Column<string>(type: "STRING", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepositoryId = table.Column<long>(type: "INT", nullable: false),
                    DayUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    VisitorKey = table.Column<string>(type: "STRING", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "INT", nullable: false),
                    SnapshotId = table.Column<string>(type: "STRING", maxLength: 32, nullable: false),
                    RepositoryId = table.Column<long>(type: "INT", nullable: false),
                    AlgorithmVersion = table.Column<string>(type: "STRING", maxLength: 32, nullable: false),
                    CalculatedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    CommitScore = table.Column<double>(type: "FLOAT", nullable: false),
                    StarScore = table.Column<double>(type: "FLOAT", nullable: false),
                    DownloadScore = table.Column<double>(type: "FLOAT", nullable: false),
                    PageViewScore = table.Column<double>(type: "FLOAT", nullable: false),
                    TotalScore = table.Column<double>(type: "FLOAT", nullable: false),
                    Rank = table.Column<int>(type: "INT", nullable: false),
                    Explanation = table.Column<string>(type: "STRING", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceType = table.Column<string>(type: "STRING", maxLength: 24, nullable: false),
                    ResourceId = table.Column<string>(type: "STRING", maxLength: 128, nullable: false),
                    Kind = table.Column<string>(type: "STRING", maxLength: 32, nullable: false),
                    Status = table.Column<string>(type: "STRING", maxLength: 16, nullable: false),
                    Title = table.Column<string>(type: "STRING", maxLength: 300, nullable: false),
                    Url = table.Column<string>(type: "STRING", maxLength: 600, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    ...
                    SnoozedUntilUtc = table.Column<DateTime>(type: "DATETIME", nullable: true),
